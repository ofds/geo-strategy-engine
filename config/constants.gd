...
const HEX_SIZE_M: float = 10000.0             # Point-to-point diameter (10 km)
const HEX_WIDTH_M: float = 10000.0            # Flat-top hex width
const HEX_HEIGHT_M: float = 8660.0            # Flat-top hex height (width * sqrt(3)/2)
...
const GRID_FADE_ALTITUDE_M: float = 300000.0  # Opacity reduces above this (300 km)
const GRID_DEFAULT_MACRO_VISIBLE: bool = true
const GRID_DEFAULT_MICRO_VISIBLE: bool = false
